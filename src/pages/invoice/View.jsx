            ...
            <tbody>
                ...
                lineItems?.map((row, index) => {
                  return (
                    <tr key={index} className="bg-white border-b border-black ">
                      ...
                      <td className="px-6 py-4">{row?.item} <br /> {row?.desc}</td>
              ...
              <tr className="">
                <th scope="col" className=" w-10">
                  ...
                  <p className="text-left w-96 text-xs">
                    Once payment is made, there will be no refund, therefore we
