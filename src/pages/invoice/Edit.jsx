...
function InvoiceUpdate () {
    ...
    const [formData, setFormData] = React.useState({vat: 7.5, service_charge: 10})
    ...
    const getInvoice = async (id) => {
        try {
            ...
            console.log('res invoice :>> ', res, console.log('res.line_items :>> ', JSON.parse(res.line_items)));
    ...
    return <>
        ...
        <div className="m-5">
            ...
            <div className="mt-8">
            <button onClick={updateInvoice} className="bg-orange-200 hover:bg-orange-300  font-medium rounded text-sm px-5 py-0.5 mr-2 mb-2">
